...
本脚本仅供学习交流，绝不以任何形式收取任何费用，如果你是付钱获取的，你可真的憨批。
...
>
> 1. :link: 最新视频链接：https://www.bilibili.com/video/BV1rK4y1d7kS
> 2. :link:工程更新链接：https://github.com/TinyHandsome/FxxkOnmyoji
> 3. :alarm_clock: 本文档更新时间：<span style="color: #FF9966; font-weight: bold">20220311</span>，请记得看最新文档。
> 4. :house: 粉丝群：<span style="color: #FF6666; font-weight: bold">1060163543</span>，神秘代码：<span style="color: #FF6666; font-weight: bold">为干饭而来</span>
> 5. :warning: 除去了Gitee的链接，**Gitee已不可信**，过段时间我将注销在Gitee上的账户（<u>垃圾Gitee不让删库、删账户，还吞我代码，我与Gitee不共戴天(大声)</u>），~~并且删除其他的库，不再更新，~~  **所有的更新只在Github上，请周知**。
> 6. :lock: CSDN、Bilibili 的 相关文档/视频 都已经没有（<u>现在有了，但不知道能活多久，进群啥都有，懂我什么意思叭</u>），我进行了部分补充，但是被删也是迟早的事情，再被删我也懒得补了，**大家请以Github为准**。

### 重要声明 | Announcement

1. **目的**：本项目旨在实现鼠标、键盘的自动化宏脚本，满足自定义流程的需求。包括但不限于解决日常办公、游戏娱乐等重复性工作。此外，本项目是本人学习python时自发编写，旨在加强能力、提高技能、学以致用，仅以交流学习为目的分享给有志之士。
2. **声明**：<u>仅供学习交流</u>，不允许用于任何商业用途。 使用该项目造成的任何后果与本人无关。<u>严禁任何转载</u>，侵权必究。
3. **门槛**：本项目不是无脑使用的，有一定的学习门槛，看文档看视频是基本要求，对于不懂python的人至少要把视频看完了再在群里问问题，带图说话。<u>回答你的问题不是义务。</u>
4. **反馈**：发现任何bug都可以通过github、博客园、csdn或者进群留言给我，联系方式在文末。该群用于 **交流Python** 相关问题，不仅仅服务于该项目，还服务于b站粉丝、CSDN粉丝、直播粉丝等。发言请注意言行，务必遵守法律。
5. **致谢**：该文档大部分内容都是基于《阴阳师》进行测试，感谢《阴阳师》游戏提供测试的机会，我反对任何外挂行为，也反对将任何行为视为外挂行为的行为。<u>该项目无意损害任何人的利益，不想侵犯任何著作权，不会破坏任何计算机信息系统</u>，如有，请及时沟通删除。尊重是平等交流的起点，个体虽弱，但并不惧利维坦。
6. 游戏不是全部人生，愿你积极向上，愿你学有所成，祝你幸福。

### 更新日志 | Update

- 20220313：
  1. 删除elevate、pyperclip依赖包及相应的代码
